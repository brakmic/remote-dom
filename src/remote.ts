import { Node, Commands, 
        ...
        StyleAttributes, EventDOMNodeAttributes, 
        SupportedEvents, Pipe}  from './common'
...
class RemoteStyle {
  constructor(private $index, private $values) {
    this.$index = $index;
    this.$values = {};
  }
}
...
class RemoteElement extends RemoteNode {
  ...
  constructor(tagName) {
    ...
    this.$style = new RemoteStyle(this.$index, undefined);
    this.$attr = {};
  }
...
export function setChannel(channel, timerFunction) {
